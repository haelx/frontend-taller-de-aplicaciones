...
class registrarRol extends StatefulWidget {
  const registrarRol({Key? key}) : super(key: key);

  @override
  registrarRolState createState() {
    return registrarRolState();
  }
}

class registrarRolState extends State<registrarRol> {
  @override
  ...
  Future<void> registrarregistrarRol(BuildContext context) async {
    Dio dio = new Dio();
    if (!kIsWeb) {
    ...
    var urlLink = globals.apiUrl + "crearRol.php";
